var colors = [0xF9B52C];
var width = window.innerWidth - 372, height = window.innerHeight - 80;
...
var stage = new Stage(document.getElementById('orange'));
...
function tick() {
    ...
    for (var i = 0; i < particles.length / 2; i++) {
        ...
        if (p.position.y > height / 2 && !p.removed) {
